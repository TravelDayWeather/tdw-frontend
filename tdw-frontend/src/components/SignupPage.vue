<template>
    ...
    <div>
      ...
      <input type="password" v-model="signUpRequest.pw" placeholder="Enter Password" class="signup-input-field" required>
      <h3 class="signup-name-input signup-input">name</h3>
      <input type="text" v-model="signUpRequest.name" placeholder="Enter Your Name" class="signup-input-field" required>
      <h3 class="signup-nickname-input signup-input">nickname</h3>
      <input type="text" v-model="signUpRequest.nickname" placeholder="Enter Nickname" class="signup-duplicate-input-field" required>
      ...
      <input type="text" v-model="signUpRequest.phone" placeholder="Enter Phone Number" class="signup-input-field" required>
    </div>
    <div>
